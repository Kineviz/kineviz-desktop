...
Open the releases page, go to the latest version **v0.10.0**, and download the file that matches your operating system:
...
| File | Chip | Notes |
| --- | --- | --- |
| [`Kineviz-Desktop-Setup-0.10.0-win-x64.exe`](https://github.com/Kineviz/kineviz-desktop/releases/download/v0.10.0/Kineviz-Desktop-Setup-0.10.0-win-x64.exe) | Intel / AMD (x64) | **Recommended** — standard installer, just double-click to install |
| [`Kineviz-Desktop-Setup-0.10.0-win-arm64.exe`](https://github.com/Kineviz/kineviz-desktop/releases/download/v0.10.0/Kineviz-Desktop-Setup-0.10.0-win-arm64.exe) | ARM64 | **Recommended** — standard installer for ARM-based PCs |
| [`Kineviz-Desktop-0.10.0-win-x64.zip`](https://github.com/Kineviz/kineviz-desktop/releases/download/v0.10.0/Kineviz-Desktop-0.10.0-win-x64.zip) | Intel / AMD (x64) | Portable archive — unzip and run directly |
| [`Kineviz-Desktop-0.10.0-win-arm64.zip`](https://github.com/Kineviz/kineviz-desktop/releases/download/v0.10.0/Kineviz-Desktop-0.10.0-win-arm64.zip) | ARM64 | Portable archive — unzip and run directly |
...
| File | Chip | Notes |
| --- | --- | --- |
| [`Kineviz-Desktop-0.10.0-mac-x64.dmg`](https://github.com/Kineviz/kineviz-desktop/releases/download/v0.10.0/Kineviz-Desktop-0.10.0-mac-x64.dmg) | Intel | **Recommended** — disk image installer |
| [`Kineviz-Desktop-0.10.0-mac-arm64.dmg`](https://github.com/Kineviz/kineviz-desktop/releases/download/v0.10.0/Kineviz-Desktop-0.10.0-mac-arm64.dmg) | Apple Silicon (M1/M2/M3, etc.) | **Recommended** — disk image installer |
| [`Kineviz-Desktop-0.10.0-mac-x64.zip`](https://github.com/Kineviz/kineviz-desktop/releases/download/v0.10.0/Kineviz-Desktop-0.10.0-mac-x64.zip) | Intel | Archive form |
| [`Kineviz-Desktop-0.10.0-mac-arm64.zip`](https://github.com/Kineviz/kineviz-desktop/releases/download/v0.10.0/Kineviz-Desktop-0.10.0-mac-arm64.zip) | Apple Silicon | Archive form |
...
1. Double-click the downloaded `Kineviz-Desktop-Setup-0.10.0-win-x64.exe` (or the `-win-arm64.exe` build for ARM-based PCs).
